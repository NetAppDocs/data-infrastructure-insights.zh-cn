...
如果您注意到您的AU在尝试连接到DII时被阻止，请尝试将这些端点添加到您的代理中：
...
您可能需要的特定 NetApp Console 代理端点列于 link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["控制台设置管理员"] 文档中。
