...
=== Data Infrastructure Insights 的 AI 助手可供所有人使用！

Data Infrastructure Insights AI Assistant 可供预览，现在包括以下增强功能：

* Azure 区域可用性：对于其 DII 站点托管在 Azure 上的客户，DII Assistant 现已准备好为您提供帮助。
* 长达 7 天的数据：助理现在可以访问长达 7 天的高分辨率指标，从而实现更广泛的数据分析和见解。
