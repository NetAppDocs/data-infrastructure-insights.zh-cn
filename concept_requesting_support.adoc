...
[role="lead"]
Data Infrastructure Insights 提供全面的支持选项，包括自助服务资源、社区论坛、文档和技术支持。通过选择 *Help > Support* 访问这些支持资源，并考虑激活您的支持权益，以通过网络工单和电话支持解锁完整的技术援助。
...
强烈建议您在支持会话期间选中此框，以允许 NetApp 支持工程师访问您的 Data Infrastructure Insights 站点。这样可以让工程师对问题进行故障排除，并帮助您快速解决问题。当支持工程师可以访问您的站点时，他们将能够执行所有管理员级别的功能。

当您的问题得到解决或您的支持会话结束时，您可以取消选中此框。

您可以前往 link:https://www.netapp.com/support-and-training/["NetApp 支持站点"] 申请客服支持。您必须具有有效的 Data Infrastructure Insights 订阅。
