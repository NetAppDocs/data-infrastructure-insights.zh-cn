...
summary: 直接通过 API 访问报告数据库，绕过 Cognos 进行自定义集成、自动化报告和高级数据分析工作流。 
...
Data Infrastructure Insights Reporting API 遵循link:https://www.odata.org/["OData v4"]（开放数据协议）标准来查询报告数据库。如需了解更多信息，请查看link:https://www.odata.org/getting-started/basic-tutorial/["本教程"]上有关 OData 的内容。
