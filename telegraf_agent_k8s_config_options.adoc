...
|  | 未受保护 | 请参见此link:https://community.influxdata.com/t/updating-telegraf-to-version-1-29-5-crashes-kubernetes-pod/33376["已知电报问题描述"]。设置_UNprotECed_将指示Kubelnetes Monitoring Operator使用标志运行Telegraf `--unprotected`。 
